    ...
    return (
        ...
        <div id="cart" className="relative">
            ...
            z-40 rounded-md w-5/6 border-2 border-gray-500">
                ...
                <h1 className="text-4xl text-center py-1 font-Roboto text-white">Carrito</h1> 
                
                <div>{cart.map((item) => {return <ItemCart totals={totals} key={item.id} data={item} deleteFromCart={deleteFromCart} addOneFromCart={addOneFromCart} />})}</div>
