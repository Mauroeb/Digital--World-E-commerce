...
const Cart = ({cart, deleteFromCart, clearCart}) => {
    ...
    return (
        ...
        <div id="cart">
            <div className="absolute w-10/12 min-h-300p w-1/3 bg-gray-800 mx-auto absolute top-20 left-1/2 transform -translate-x-1/2 z-50 rounded-md w-5/6 border-2 border-gray-500">
